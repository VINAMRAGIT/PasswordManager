...
public class Authenticator
{
    private static final File SALT_FILE = new File(
            "C:\\Users\\vinam\\IdeaProjects\\FX_PassManage_App\\src\\main\\resources\\data\\SALT_FILE.enc");
    private static final File HASH_FILE = new File(
            "C:\\Users\\vinam\\IdeaProjects\\FX_PassManage_App\\src\\main\\resources\\data\\HASH_FILE.enc");
     ...
     *
     * @param message password passed as input by the client
     * @return boolean showing whether the message's hash matches the password's hash
     */
    public boolean checkHash(String message)
    throws
    ...
    InvalidKeySpecException
    {
        return Arrays.equals(SecretKeyFactory.getInstance(algorithm)
                                             .generateSecret(
                                                     new PBEKeySpec(message.toCharArray(),
                                                                    salt,
                                                                    65536,
                                                                    128))
                                             .getEncoded(),
